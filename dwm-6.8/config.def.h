...
static const int sidepad            = 650;      /* horizontal padding of bar */
static const unsigned int bottom_gap = 400;  // Adjust gap size here
...
static const Key keys[] = {
	...
	{ MODKEY,	    XK_s,		     spawn,	     SHCMD("surf-open.sh") },
	...
	{ MODKEY,	    XK_p,		     spawn,          SHCMD("st -e pacmixer") },
	...
	{ MODKEY,	    XK_End,		     spawn,          SHCMD("shutdown.sh") },
