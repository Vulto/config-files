...
cfg() {
	find -name "*rc" | fzf --bind 'enter:execute(nvim {})' 
}

__fzf_open__() {
	fzf --bind 'enter:execute(nopen {})'
}
...
__remove_programs__() {
	pacman -Qq | fzf --preview 'pacman -Qil {}' | xargs -ro doas pacman -Rns
}

__install_programs__() {
	pacman -Slq | fzf --preview 'pacman -Si {}' | xargs -ro doas pacman -S
}
